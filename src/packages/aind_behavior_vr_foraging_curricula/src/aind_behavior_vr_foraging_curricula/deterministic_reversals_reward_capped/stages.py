...
from ..deterministic_reversals._stages_shared import (
    make_s_stage_reversal_baseline as _make_s_stage_reversal_baseline,
)
...
make_s_stage_reversal_baseline = partial(
    _make_s_stage_reversal_baseline, delayed_reward_available=15, cap_delayed_rewards=True
)

__all__ = [
    "make_s_stage_all_odors_rewarded",
    "make_s_stage_graduation",
    "make_s_stage_reversal_baseline",
]
