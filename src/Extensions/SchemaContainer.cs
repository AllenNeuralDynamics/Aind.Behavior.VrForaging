...
namespace AindVrForaging
{
    ...
    public partial class NumericalUpdater
    {
        ...
        private NumericalUpdaterOperation _operation = AindVrForaging.NumericalUpdaterOperation.None;
    ...
    public partial class OlfactometerChannelConfig
    {
        ...
        private OlfactometerChannelType _channelType = AindVrForaging.OlfactometerChannelType.Odor;
    
        private OlfactometerChannelConfigFlowRateCapacity _flowRateCapacity = AindVrForaging.OlfactometerChannelConfigFlowRateCapacity._100;
    ...
    public partial class PatchRewardFunction
    {
        ...
        private DepletionRule _depletionRule = AindVrForaging.DepletionRule.OnChoice;
    ...
    public partial class SpinnakerCamera
    {
        ...
        private SpinnakerCameraColorProcessing _colorProcessing = AindVrForaging.SpinnakerCameraColorProcessing.Default;
    ...
    public partial class VirtualSite
    {
        ...
        private VirtualSiteLabels _label = AindVrForaging.VirtualSiteLabels.Unspecified;
    ...
    [Bonsai.CombinatorAttribute()]
    [Bonsai.WorkflowElementCategoryAttribute(Bonsai.ElementCategory.Source)]
    public partial class SchemaContainer
    {
    
        private AindVrForagingRig _rig = new AindVrForagingRig();
    
        private AindVrForagingTaskLogic _taskLogic = new AindVrForagingTaskLogic();
    
        private AindBehaviorSessionModel _session = new AindBehaviorSessionModel();
    
        public SchemaContainer()
        {
        }
    
        protected SchemaContainer(SchemaContainer other)
        {
            _rig = other._rig;
        ...
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        [Newtonsoft.Json.JsonPropertyAttribute("task_logic", Required=Newtonsoft.Json.Required.Always)]
        public AindVrForagingTaskLogic TaskLogic
        {
            get
            {
                return _taskLogic;
        ...
        public System.IObservable<SchemaContainer> Process()
        {
            return System.Reactive.Linq.Observable.Defer(() => System.Reactive.Linq.Observable.Return(new SchemaContainer(this)));
        }
    
        public System.IObservable<SchemaContainer> Process<TSource>(System.IObservable<TSource> source)
        {
            return System.Reactive.Linq.Observable.Select(source, _ => new SchemaContainer(this));
        }
    
        protected virtual bool PrintMembers(System.Text.StringBuilder stringBuilder)
        {
            stringBuilder.Append("rig = " + _rig + ", ");
            stringBuilder.Append("task_logic = " + _taskLogic + ", ");
    ...
    public partial class SerializeToJson
    {
        ...
        public System.IObservable<string> Process(System.IObservable<SchemaContainer> source)
        {
            return Process<SchemaContainer>(source);
        }
    ...
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(Bonsai.Expressions.TypeMapping<SchemaContainer>))]
    ...
    public partial class DeserializeFromJson : Bonsai.Expressions.SingleArgumentExpressionBuilder
    {
        ...
        {
            Type = new Bonsai.Expressions.TypeMapping<SchemaContainer>();
        }
