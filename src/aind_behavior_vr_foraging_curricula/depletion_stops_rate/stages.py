...
def s_stage_all_odors_rewarded() -> Stage:
    return Stage(
                            ...
                            environment_statistics=task_logic.EnvironmentStatistics(
                                ...
                                patches=[
                                    helpers.make_graduated_patch(
                                        ...
                                        state_index=1,
                                        odor_index=1,
                                        max_reward_probability=0.929814241484,
                                        rate_reward_probability=0.969,
                                        rule="ON_CHOICE",
                                    ),
                                    helpers.make_graduated_patch(
                                        label="odor_fast",
